...
class SlowlyApiTest {
    ...
    @Test
    fun `getPokeApi() should return Fallback data`() {
        // given
        ...
        // expect
        assertEquals("Fallback", client.getPokeApi().data)
    }

    @Test
    fun `client are working`(){
        assertEquals("bulbasaur", realClient.getPokeApi().data)
    }
